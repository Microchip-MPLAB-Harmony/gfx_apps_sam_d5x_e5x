...
leResult screenInit_ColorScreen(void)
{
...
leResult screenShow_ColorScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenUpdate_ColorScreen(void)
{
    ColorScreen_OnUpdate(); // raise event
}

void screenHide_ColorScreen(void)
{
...
void screenDestroy_ColorScreen(void)
{
