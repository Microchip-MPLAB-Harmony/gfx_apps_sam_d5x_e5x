...
leResult screenInit_KeypadDemoScreen(void)
{
...
leResult screenShow_KeypadDemoScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_KeypadDemoScreen(void)
{
...
void screenDestroy_KeypadDemoScreen(void)
{
