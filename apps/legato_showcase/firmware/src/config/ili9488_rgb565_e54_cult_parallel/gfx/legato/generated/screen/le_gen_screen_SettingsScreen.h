...
leResult screenInit_SettingsScreen(void); // called when Legato is initialized
leResult screenShow_SettingsScreen(void); // called when screen is shown
void screenHide_SettingsScreen(void); // called when screen is hidden
void screenDestroy_SettingsScreen(void); // called when Legato is destroyed
void screenUpdate_SettingsScreen(void); // called when Legato is updating

leWidget* screenGetRoot_SettingsScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void SettingsScreen_OnShow(void); // called when this screen is shown
void SettingsScreen_OnUpdate(void); // called when this screen is updated
