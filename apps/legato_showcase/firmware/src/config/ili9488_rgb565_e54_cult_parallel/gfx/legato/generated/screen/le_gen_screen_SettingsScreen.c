...
leResult screenInit_SettingsScreen(void)
{
...
leResult screenShow_SettingsScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_SettingsScreen(void)
{
...
void screenDestroy_SettingsScreen(void)
{
