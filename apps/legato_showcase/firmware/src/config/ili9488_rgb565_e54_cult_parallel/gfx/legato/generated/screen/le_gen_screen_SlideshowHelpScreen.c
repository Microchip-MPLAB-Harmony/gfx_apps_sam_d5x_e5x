...
leResult screenInit_SlideshowHelpScreen(void)
{
...
leResult screenShow_SlideshowHelpScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_SlideshowHelpScreen(void)
{
...
void screenDestroy_SlideshowHelpScreen(void)
{
