...
leResult screenInit_AlphaBlendingDemoScreen(void)
{
...
leResult screenShow_AlphaBlendingDemoScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenUpdate_AlphaBlendingDemoScreen(void)
{
...
void screenHide_AlphaBlendingDemoScreen(void)
{
...
void screenDestroy_AlphaBlendingDemoScreen(void)
{
