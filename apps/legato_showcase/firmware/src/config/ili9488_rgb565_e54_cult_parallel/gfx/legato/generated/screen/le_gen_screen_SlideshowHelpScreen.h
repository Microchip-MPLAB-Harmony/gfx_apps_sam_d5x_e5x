...
leResult screenInit_SlideshowHelpScreen(void); // called when Legato is initialized
leResult screenShow_SlideshowHelpScreen(void); // called when screen is shown
void screenHide_SlideshowHelpScreen(void); // called when screen is hidden
void screenDestroy_SlideshowHelpScreen(void); // called when Legato is destroyed
void screenUpdate_SlideshowHelpScreen(void); // called when Legato is updating

leWidget* screenGetRoot_SlideshowHelpScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void SlideshowHelpScreen_OnShow(void); // called when this screen is shown
void SlideshowHelpScreen_OnUpdate(void); // called when this screen is updated
