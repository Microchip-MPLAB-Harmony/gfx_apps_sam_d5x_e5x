...
leResult screenInit_ListWheelDemoScreen(void); // called when Legato is initialized
leResult screenShow_ListWheelDemoScreen(void); // called when screen is shown
void screenHide_ListWheelDemoScreen(void); // called when screen is hidden
void screenDestroy_ListWheelDemoScreen(void); // called when Legato is destroyed
void screenUpdate_ListWheelDemoScreen(void); // called when Legato is updating

leWidget* screenGetRoot_ListWheelDemoScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void ListWheelDemoScreen_OnShow(void); // called when this screen is shown
void ListWheelDemoScreen_OnUpdate(void); // called when this screen is updated
