...
leResult screenInit_AlphaBlendingDemoScreen(void); // called when Legato is initialized
leResult screenShow_AlphaBlendingDemoScreen(void); // called when screen is shown
void screenHide_AlphaBlendingDemoScreen(void); // called when screen is hidden
void screenDestroy_AlphaBlendingDemoScreen(void); // called when Legato is destroyed
void screenUpdate_AlphaBlendingDemoScreen(void); // called when Legato is updating

leWidget* screenGetRoot_AlphaBlendingDemoScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void AlphaBlendingDemoScreen_OnShow(void); // called when this screen is shown
void AlphaBlendingDemoScreen_OnHide(void); // called when this screen is hidden
void AlphaBlendingDemoScreen_OnUpdate(void); // called when this screen is updated
