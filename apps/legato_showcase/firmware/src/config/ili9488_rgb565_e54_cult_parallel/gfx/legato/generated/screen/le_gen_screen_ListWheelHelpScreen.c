...
leResult screenInit_ListWheelHelpScreen(void)
{
...
leResult screenShow_ListWheelHelpScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_ListWheelHelpScreen(void)
{
...
void screenDestroy_ListWheelHelpScreen(void)
{
