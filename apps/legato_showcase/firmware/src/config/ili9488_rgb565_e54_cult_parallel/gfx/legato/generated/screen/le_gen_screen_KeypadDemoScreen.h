...
leResult screenInit_KeypadDemoScreen(void); // called when Legato is initialized
leResult screenShow_KeypadDemoScreen(void); // called when screen is shown
void screenHide_KeypadDemoScreen(void); // called when screen is hidden
void screenDestroy_KeypadDemoScreen(void); // called when Legato is destroyed
void screenUpdate_KeypadDemoScreen(void); // called when Legato is updating

leWidget* screenGetRoot_KeypadDemoScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void KeypadDemoScreen_OnShow(void); // called when this screen is shown
void KeypadDemoScreen_OnHide(void); // called when this screen is hidden
void KeypadDemoScreen_OnUpdate(void); // called when this screen is updated
