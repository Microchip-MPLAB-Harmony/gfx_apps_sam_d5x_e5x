...
leResult screenInit_AlphaBlendingHelpScreen(void); // called when Legato is initialized
leResult screenShow_AlphaBlendingHelpScreen(void); // called when screen is shown
void screenHide_AlphaBlendingHelpScreen(void); // called when screen is hidden
void screenDestroy_AlphaBlendingHelpScreen(void); // called when Legato is destroyed
void screenUpdate_AlphaBlendingHelpScreen(void); // called when Legato is updating

leWidget* screenGetRoot_AlphaBlendingHelpScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void AlphaBlendingHelpScreen_OnShow(void); // called when this screen is shown
void AlphaBlendingHelpScreen_OnUpdate(void); // called when this screen is updated
