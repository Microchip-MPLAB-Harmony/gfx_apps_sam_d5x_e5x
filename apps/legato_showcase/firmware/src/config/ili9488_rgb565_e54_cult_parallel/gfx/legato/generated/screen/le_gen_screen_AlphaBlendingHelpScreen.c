...
leResult screenInit_AlphaBlendingHelpScreen(void)
{
...
leResult screenShow_AlphaBlendingHelpScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_AlphaBlendingHelpScreen(void)
{
...
void screenDestroy_AlphaBlendingHelpScreen(void)
{
