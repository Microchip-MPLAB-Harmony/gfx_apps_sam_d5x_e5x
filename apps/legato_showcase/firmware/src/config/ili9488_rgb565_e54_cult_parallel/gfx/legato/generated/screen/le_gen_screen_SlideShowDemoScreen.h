...
leResult screenInit_SlideShowDemoScreen(void); // called when Legato is initialized
leResult screenShow_SlideShowDemoScreen(void); // called when screen is shown
void screenHide_SlideShowDemoScreen(void); // called when screen is hidden
void screenDestroy_SlideShowDemoScreen(void); // called when Legato is destroyed
void screenUpdate_SlideShowDemoScreen(void); // called when Legato is updating

leWidget* screenGetRoot_SlideShowDemoScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void SlideShowDemoScreen_OnShow(void); // called when this screen is shown
void SlideShowDemoScreen_OnHide(void); // called when this screen is hidden
void SlideShowDemoScreen_OnUpdate(void); // called when this screen is updated
