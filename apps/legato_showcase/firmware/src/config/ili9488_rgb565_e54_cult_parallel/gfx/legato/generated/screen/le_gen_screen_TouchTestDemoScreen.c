...
leResult screenInit_TouchTestDemoScreen(void)
{
...
leResult screenShow_TouchTestDemoScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_TouchTestDemoScreen(void)
{
...
void screenDestroy_TouchTestDemoScreen(void)
{
