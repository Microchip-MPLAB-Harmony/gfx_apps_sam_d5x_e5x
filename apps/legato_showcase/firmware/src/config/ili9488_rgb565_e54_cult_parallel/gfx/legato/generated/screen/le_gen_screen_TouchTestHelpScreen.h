...
leResult screenInit_TouchTestHelpScreen(void); // called when Legato is initialized
leResult screenShow_TouchTestHelpScreen(void); // called when screen is shown
void screenHide_TouchTestHelpScreen(void); // called when screen is hidden
void screenDestroy_TouchTestHelpScreen(void); // called when Legato is destroyed
void screenUpdate_TouchTestHelpScreen(void); // called when Legato is updating

leWidget* screenGetRoot_TouchTestHelpScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void TouchTestHelpScreen_OnShow(void); // called when this screen is shown
void TouchTestHelpScreen_OnUpdate(void); // called when this screen is updated
