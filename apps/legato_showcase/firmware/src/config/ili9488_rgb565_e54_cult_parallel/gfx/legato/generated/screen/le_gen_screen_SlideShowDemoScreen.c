...
leResult screenInit_SlideShowDemoScreen(void)
{
...
leResult screenShow_SlideShowDemoScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_SlideShowDemoScreen(void)
{
...
void screenDestroy_SlideShowDemoScreen(void)
{
