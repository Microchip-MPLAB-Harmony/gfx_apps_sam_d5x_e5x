...
leResult screenInit_KeypadHelpScreen(void); // called when Legato is initialized
leResult screenShow_KeypadHelpScreen(void); // called when screen is shown
void screenHide_KeypadHelpScreen(void); // called when screen is hidden
void screenDestroy_KeypadHelpScreen(void); // called when Legato is destroyed
void screenUpdate_KeypadHelpScreen(void); // called when Legato is updating

leWidget* screenGetRoot_KeypadHelpScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void KeypadHelpScreen_OnShow(void); // called when this screen is shown
void KeypadHelpScreen_OnUpdate(void); // called when this screen is updated
