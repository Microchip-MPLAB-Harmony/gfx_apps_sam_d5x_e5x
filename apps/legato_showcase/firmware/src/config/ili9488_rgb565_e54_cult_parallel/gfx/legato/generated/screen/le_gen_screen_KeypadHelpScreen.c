...
leResult screenInit_KeypadHelpScreen(void)
{
...
leResult screenShow_KeypadHelpScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_KeypadHelpScreen(void)
{
...
void screenDestroy_KeypadHelpScreen(void)
{
