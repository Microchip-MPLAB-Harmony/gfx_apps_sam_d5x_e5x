...
leResult screenInit_ListWheelDemoScreen(void)
{
...
leResult screenShow_ListWheelDemoScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_ListWheelDemoScreen(void)
{
...
void screenDestroy_ListWheelDemoScreen(void)
{
