...
leResult screenInit_ListWheelHelpScreen(void); // called when Legato is initialized
leResult screenShow_ListWheelHelpScreen(void); // called when screen is shown
void screenHide_ListWheelHelpScreen(void); // called when screen is hidden
void screenDestroy_ListWheelHelpScreen(void); // called when Legato is destroyed
void screenUpdate_ListWheelHelpScreen(void); // called when Legato is updating

leWidget* screenGetRoot_ListWheelHelpScreen(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void ListWheelHelpScreen_OnShow(void); // called when this screen is shown
void ListWheelHelpScreen_OnUpdate(void); // called when this screen is updated
