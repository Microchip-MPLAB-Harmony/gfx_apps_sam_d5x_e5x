...
leResult screenInit_TouchTestHelpScreen(void)
{
...
leResult screenShow_TouchTestHelpScreen(void)
{
    if(showing == LE_TRUE)
        return LE_FAILURE;
...
void screenHide_TouchTestHelpScreen(void)
{
...
void screenDestroy_TouchTestHelpScreen(void)
{
