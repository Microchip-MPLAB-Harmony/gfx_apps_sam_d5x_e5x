...
leResult screenInit_MainMenuHelp(void); // called when Legato is initialized
leResult screenShow_MainMenuHelp(void); // called when screen is shown
void screenHide_MainMenuHelp(void); // called when screen is hidden
void screenDestroy_MainMenuHelp(void); // called when Legato is destroyed
void screenUpdate_MainMenuHelp(void); // called when Legato is updating

leWidget* screenGetRoot_MainMenuHelp(uint32_t lyrIdx); // gets a root widget for this screen

// Screen Events:
void MainMenuHelp_OnShow(void); // called when this screen is shown
void MainMenuHelp_OnUpdate(void); // called when this screen is updated
