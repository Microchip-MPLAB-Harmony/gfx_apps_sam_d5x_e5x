...
leResult screenShow_Screen1(void)
{
    ...
    Screen1_PanelBackground->fn->setSize(Screen1_PanelBackground, 480, 320);
    ...
    Screen1_PositionWidget->fn->setPosition(Screen1_PositionWidget, 171, 130);
    ...
    Screen1_ButtonWidget_RunLeft->fn->setPosition(Screen1_ButtonWidget_RunLeft, -240, 220);
    ...
    Screen1_ButtonWidget_RunRight->fn->setPosition(Screen1_ButtonWidget_RunRight, 240, 220);
    ...
    Screen1_ButtonWidget_Jump->fn->setSize(Screen1_ButtonWidget_Jump, 480, 220);
