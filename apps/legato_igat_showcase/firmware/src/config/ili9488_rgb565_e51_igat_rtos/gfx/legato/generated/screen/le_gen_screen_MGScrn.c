...
leResult screenShow_MGScrn(void)
{
    ...
    MGScrn_FPSLabel->fn->setPosition(MGScrn_FPSLabel, 2, 284);
    MGScrn_FPSLabel->fn->setSize(MGScrn_FPSLabel, 110, 25);
    ...
    MGScrn_MGLicenseLabel->fn->setPosition(MGScrn_MGLicenseLabel, 115, 284);
    MGScrn_MGLicenseLabel->fn->setSize(MGScrn_MGLicenseLabel, 364, 31);
