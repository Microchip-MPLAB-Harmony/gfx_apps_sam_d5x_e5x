 ...
 * Default value: 20.
 */
//CUSTOM CODE - DO NOT MODIFY THIS FILE!!!
...
//  Columns                                         Rows        
//  X(25)|X(24)|X(21)|X(31)|X(30)|X(18)|X(17),      X(16)|X(15)|X(14)|X(29)|X(28)

// Proximity sensor 1 - transmit from edges and listen at center
#define NODE_12_PARAMS                                                                                               \
{                                                                                                                  \
    X(16)|X(25)|X(28)|X(17), Y(14)|Y(31), 1, NODE_RSEL_PRSC(RSEL_VAL_6, PRSC_DIV_SEL_64), NODE_GAIN(GAIN_4, GAIN_16), FILTER_LEVEL_256 \
}
//END OF CUSTOM CODE
 ...
 *gesture.
 */
#define HORIZONTAL_SWIPE_DISTANCE_THRESHOLD 25u
 ...
 */
#define VERTICAL_SWIPE_DISTANCE_THRESHOLD 25u
/* 	Tap area <0-255>
 ...
 */
#define WHEEL_START_QUADRANT_COUNT 4
 ...
 */
#define WHEEL_REVERSE_QUADRANT_COUNT 4
 ...
 */
#define PINCH_ZOOM_THRESHOLD 60u
 ...
 * Default: 100
*/
#define QTM_LOWPOWER_TRIGGER_PERIOD       64u
 ...
 * Default: 2000
*/
#define DEF_TOUCH_DRIFT_PERIOD_MS	2048u
