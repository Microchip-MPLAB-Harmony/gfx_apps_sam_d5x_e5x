 ...
 *gesture.
 */
#define HORIZONTAL_SWIPE_DISTANCE_THRESHOLD 25
 ...
 */
#define VERTICAL_SWIPE_DISTANCE_THRESHOLD 25
/* 	Tap area <0-255>
 ...
 */
#define PINCH_ZOOM_THRESHOLD 60
