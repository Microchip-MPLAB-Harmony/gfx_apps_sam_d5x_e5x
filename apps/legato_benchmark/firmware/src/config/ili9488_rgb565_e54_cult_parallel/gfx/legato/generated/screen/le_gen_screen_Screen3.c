...
leResult screenShow_Screen3(void)
{
    ...
    Screen3_ImageBackground->fn->setSize(Screen3_ImageBackground, 480, 320);
    ...
    Screen3_ImageRenderArea->fn->setSize(Screen3_ImageRenderArea, 480, 320);
    ...
    Screen3_ImageNextButton->fn->setVisible(Screen3_ImageNextButton, LE_FALSE);
