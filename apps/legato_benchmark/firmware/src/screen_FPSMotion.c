...
static void increaseRectSize()
{
    ...
    if (rectSize == FULLSCREEN_RECT_SIZE)
    {
        ...
        motionWidgets[RECT_WIDGET_0].widget->fn->setWidth(motionWidgets[RECT_WIDGET_0].widget, rect.width);
        motionWidgets[RECT_WIDGET_0].widget->fn->setHeight(motionWidgets[RECT_WIDGET_0].widget, rect.height);
