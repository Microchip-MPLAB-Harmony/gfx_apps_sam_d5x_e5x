...
leResult screenShow_Settings(void)
{
    ...
    Settings_AdvancedGesturesEnable->fn->setEnabled(Settings_AdvancedGesturesEnable, LE_FALSE);
    Settings_AdvancedGesturesEnable->fn->setVisible(Settings_AdvancedGesturesEnable, LE_FALSE);
    ...
    Settings_SLALabel->fn->setVisible(Settings_SLALabel, LE_FALSE);
