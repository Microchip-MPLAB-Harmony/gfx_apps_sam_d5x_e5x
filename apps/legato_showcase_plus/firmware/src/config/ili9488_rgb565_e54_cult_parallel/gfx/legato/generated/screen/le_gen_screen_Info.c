...
leResult screenShow_Info(void)
{
    ...
    Info_InfoPageTitleLabel->fn->setString(Info_InfoPageTitleLabel, (leString*)&string_BoardTitle);
    ...
    Info_HWLabel->fn->setPosition(Info_HWLabel, 0, 13);
    Info_HWLabel->fn->setSize(Info_HWLabel, 180, 25);
