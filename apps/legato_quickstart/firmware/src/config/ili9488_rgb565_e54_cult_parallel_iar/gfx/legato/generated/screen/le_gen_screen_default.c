...
leResult screenShow_default(void)
{
    ...
    default_PanelWidget0->fn->setSize(default_PanelWidget0, 320, 480);
    ...
    default_ImageWidget0->fn->setPosition(default_ImageWidget0, 13, 7);
    ...
    default_ImageWidget1->fn->setPosition(default_ImageWidget1, 75, 160);
    ...
    default_ButtonWidget0->fn->setPosition(default_ButtonWidget0, 84, 354);
    ...
    default_LabelWidget0->fn->setPosition(default_LabelWidget0, 50, 100);
    ...
    default_LabelWidget1->fn->setPosition(default_LabelWidget1, 125, 100);
    ...
    default_LabelWidget2->fn->setPosition(default_LabelWidget2, 200, 100);
