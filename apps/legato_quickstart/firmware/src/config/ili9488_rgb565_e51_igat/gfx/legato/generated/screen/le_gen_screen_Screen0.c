...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_BackgroundPanel->fn->setSize(Screen0_BackgroundPanel, 480, 320);
    ...
    Screen0_mhgsLogo->fn->setPosition(Screen0_mhgsLogo, 30, 90);
    ...
    Screen0_fastLabel->fn->setPosition(Screen0_fastLabel, 225, 117);
    ...
    Screen0_easyLabel->fn->setPosition(Screen0_easyLabel, 300, 117);
    ...
    Screen0_smartLabel->fn->setPosition(Screen0_smartLabel, 375, 117);
    ...
    Screen0_qsButton->fn->setPosition(Screen0_qsButton, 256, 172);
