...
{"0": {
    ...
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "Example Applications",
    "title": "Example Applications",
    "content": "The following applications are provided to demonstrate both basic and advanced Graphics capabilities of the SAM E54 Family. ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/readme.html",
    "relUrl": "/apps/readme.html"
  },"2": {
    "doc": "Example Applications",
    "title": "Legato Library Examples",
    "content": ". | Legato IGAT Showcase | . This is the showcase graphics demonstration on the SAM E51 Integrated Graphics and Touch Development Board . | Legato Showcase Plus | . This is the showcase graphics demonstration on the SAM E54 Curiosity Ultra Development Board . | Legato Quickstart | . This demonstration provides a touch-enabled starting point for the legato graphics library. | Legato Flash | . The legato_flash demonstration application serves as an external memory programmer to flash the off-chip non-volatile memory. | Legato Quickstart External Resource | . This demonstration provides a touch-enabled starting point for reading images, string, and multiple fonts from both internal and external non-volatile memory (NVM). | Legato Showcase | . This demonstration provides a touch-enabled starting point for reading images, string, and multiple fonts from both internal and external non-volatile memory (NVM). | Legato Benchmark | . This application shows the frame update rates for various operations in the graphics library, including string rendering, area fills, and image decode and rendering. ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/readme.html#legato-library-examples",
    ...
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/readme.html#blank-library-examples",
    "relUrl": "/apps/readme.html#blank-library-examples"
  },"4": {
    "doc": "Example Applications",
    "title": "LVGL Library Examples",
    "content": ". | LVGL Showcase | . This application demonstrates a simple way to create and run a graphics application using the LVGL graphics library. ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/readme.html#lvgl-library-examples",
    "relUrl": "/apps/readme.html#lvgl-library-examples"
  },"5": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "# ![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_d5x_e5x/images/mhgs.png) Microchip MPLAB® Harmony 3 Graphics application examples for SAM D5x/E5x Family ## Harmony 3 Graphics application examples for SAM D5x/E5x family v3.11.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------:|:-------------------:| [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) | 9 | [SAM E51 Integrated Graphics and Touch Development Board](https://www.microchip.com/developmenttools/ProductDetails/EV14C17A) | 4 | ## Release v3.11.0 ### New Features New features added in this release are as follows: - Added **LVGL Showcase** for IGaT Development Board ### Development Tools - [MPLAB® X IDE v6.20](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - [MPLAB® Code Configurator (MCC) Plugin v5.4.1](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® Code Configurator (MCC) Core v5.6.1](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® XC32 C/C++ Compiler v4.35](https://www.microchip.com/mplab/compilers) ### Dependent Components * [Harmony 3 GFX v3.14.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.14.0) * [Harmony 3 TOUCH v3.14.0](https://github.com/Microchip-MPLAB-Harmony/touch/releases/tag/v3.14.0) ## Release v3.10.0 ### New Features New features added in this release are as follows: - Added MCC Configurations ## Release v3.9.3 ### New Features New features added in this release are as follows: - Added Low Power mode and Proximity Sensing support to **Legato IGaT Showcase** - Added RTOS version of **Legato IGaT Showcase** with CPU usage metrics ## Release v3.9.2 ### New Features New features added in this release are as follows: - Added **Legato Showcase Plus** for the SAM E54 Curiosity Ultra Development Board - **Legato Cooker**, **Legato Adventure** and **Legato Monitor** are removed as their features are replicated in **Legato Showcase Plus** - USB MSD reader support added to **Legato Flash** ## Release v3.9.1 ### New Features New features added in this release are as follows: - Added Legato Quickstart for the IGaT Development Board - Added Legato IGaT Showcase for the IGaT Development Board ## Release v3.9.0 ### New Features New features added in this release are as follows: - Applications migrated from gfx and gfx_apps repository to this new application repository for SAM D5x/E5x development support - Added legato_qs_e54_cult_cpro_parallel.IAR and legato_qs_e54_cu_tm4301b_ssd1963.IAR configurations ### Known Issues The current known issues are as follows: - For all IAR configurations, make sure LE_DYNAMIC_VTABLES is define to 1 to ensure build success ### Development Tools - [MPLAB® X IDE v6.05](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - [MPLAB® Harmony Configurator (MHC) v3.8.5](https://www.microchip.com/en-us/tools-resources/configure/mplab-code-configurator). - [MPLAB® Code Configurator (MCC) v5.2.2](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® XC32 C/C++ Compiler v4.20](https://www.microchip.com/mplab/compilers) ### Dependent Components * [Harmony 3 GFX v3.12.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.12.0) * [Harmony 3 TOUCH v3.13.0](https://github.com/Microchip-MPLAB-Harmony/touch/releases/tag/v3.13.0) ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/release_notes.html",
    "relUrl": "/release_notes.html"
  },"6": {
    "doc": "Blank Quickstart",
    "title": "Blank Quickstart",
    "content": "# Blank Quickstart ![](/gfx_apps_sam_d5x_e5x/images/blank_quickstart.png) This demonstration provides a starting point to integrate a third-party graphics library with MPLAB Harmony Graphics Suite. |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [blank_quickstart_e54_cult_cpro_spi.X](/gfx_apps_sam_d5x_e5x/apps/blank_quickstart/firmware/blank_quickstart_e54_cult_cpro_spi.X/) | [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) with a 24-bit pass-through GFX interface card and a [maXTouch® Curiosity Pro Board](https://www.microchip.com/Developmenttools/ProductDetails/AC320007) |blank_quickstart_e54_cult_cpro_spi.X ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/blank_quickstart/",
    "relUrl": "/apps/blank_quickstart/"
  },"7": {
    "doc": "Legato Benchmark",
    "title": "Legato Benchmark",
    "content": "# Legato Benchmark ![](/gfx_apps_sam_d5x_e5x/images/legato_benchmark.png) This application shows the frame update rates for various operations in the graphics library, including string rendering, area fills, and image decode and rendering. |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato_bm_e54_cu_cpro_parallel.X](/gfx_apps_sam_d5x_e5x/apps/legato_benchmark/firmware/legato_bm_e54_cu_cpro_parallel.X/) | [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) using external ILI9488 controller to drive the [maXTouch® Curiosity Pro Board](https://www.microchip.com/Developmenttools/ProductDetails/AC320007) | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_benchmark/",
    "relUrl": "/apps/legato_benchmark/"
  },"8": {
    "doc": "Legato Flash",
    "title": "Legato Flash",
    "content": "# Legato Flash ![](/gfx_apps_sam_d5x_e5x/images/legato_flash.png) The legato_flash demonstration application serves as an external memory programmer to flash the off-chip non-volatile memory with the resources held on an Memory Storage Device (MSD), such as a USB MSD or an SD EMMC, which can then be accessed by other applications saving on-chip memory for other programs and resources. The application [legato_quickstart_external_resources](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart_ext_res/) in MPLAB Harmony needs to use preloaded images/fonts from QSPI flash external non-volatile memory. This would require legato_flash to flash the required image and font resources onto the QSPI flash. Refer to [legato_quickstart_external_resources](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart_ext_res/) for usage model information. ![](/gfx_apps_sam_d5x_e5x/images/external_resources_flash_reader_diagram.png) |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato_fl_e54_cult_cpro_parallel.X](/gfx_apps_sam_d5x_e5x/apps/legato_flash/firmware/legato_fl_e54_cult_cpro_parallel.X/)| [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) using external ILI9488 controller to drive the [maXTouch® Curiosity Pro Board](https://www.microchip.com/Developmenttools/ProductDetails/AC320007) | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_flash/",
    "relUrl": "/apps/legato_flash/"
  },"9": {
    "doc": "Legato SAM E51 Integrated Graphics and Touch Showcase",
    "title": "Legato SAM E51 Integrated Graphics and Touch Showcase",
    "content": "# Legato SAM E51 Integrated Graphics and Touch Showcase ![](/gfx_apps_sam_d5x_e5x/images/legato_sc_e51_igat.png) This is the showcase graphics demonstration on the SAME51 Integrated Graphics and Touch Development Board. There are two configurations of this demonstration. |MPLABX Configuration|Board Configuration|Description|:-------------------|:------------------|:------------------| [legato_sc_e51_igat.X](/gfx_apps_sam_d5x_e5x/apps/legato_igat_showcase/firmware/legato_sc_e51_igat.X/)| [SAM E51 Integrated Graphics and Touch Development Board](https://www.microchip.com/developmenttools/ProductDetails/EV14C17A) | Non-RTOS configuration | [legato_sc_e51_igat_rtos.X](/gfx_apps_sam_d5x_e5x/apps/legato_igat_showcase/firmware/legato_sc_e51_igat_rtos.X/)| [SAM E51 Integrated Graphics and Touch Development Board](https://www.microchip.com/developmenttools/ProductDetails/EV14C17A) | RTOS configuration with CPU usage information | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_igat_showcase/",
    "relUrl": "/apps/legato_igat_showcase/"
  },"10": {
    "doc": "Legato Quickstart",
    "title": "Legato Quickstart",
    "content": "# Legato Quickstart ![](/gfx_apps_sam_d5x_e5x/images/legato_quickstart.png) This demonstration provides a touch-enabled starting point for the legato graphics library. |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato\\_qs\\_e54\\_cu\\_cpro\\_spi.X](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart/firmware/legato_qs_e54_cu_cpro_spi.X/)| [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) with a 24-bit pass-through GFX interface card and a [maXTouch® Curiosity Pro Board](https://www.microchip.com/Developmenttools/ProductDetails/AC320007) | [legato\\_qs\\_e54\\_cu\\_tm4301b\\_ssd1963.X](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart/firmware/legato_qs_e54_cu_tm4301b_ssd1963.X/) | [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) using external ssd1963 controller to drive the [High-Performance WQVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-4) | [legato\\_qs\\_e54\\_cult\\_xpro\\_parallel.X](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart/firmware/legato_qs_e54_cult_cpro_parallel.X/) | [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) with a 24-bit passthrough GFX interface card and a [maXTouch Curiosity Pro Extension Kit](https://www.microchip.com/Developmenttools/ProductDetails/ATMXT-XPRO) | [legato\\_qs\\_e51\\_igat.X](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart/firmware/legato_qs_e51_igat.X/) | [SAM E51 Integrated Graphics and Touch Development Board](https://www.microchip.com/developmenttools/ProductDetails/EV14C17A) | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_quickstart/",
    "relUrl": "/apps/legato_quickstart/"
  },"11": {
    "doc": "Legato Quickstart External Resource",
    "title": "Legato Quickstart External Resource",
    "content": "# Legato Quickstart External Resource ![](/gfx_apps_sam_d5x_e5x/images/legato_quickstart_ext_res.png) The legato_quickstart_external_resources (external flash reader) application demonstrates reading multiple images, multi-lingual strings and multiple font assets from both internal and external non-volatile memory (NVM). The external resources are pre-programmed into the NVM using the legato_flash demonstration application. The intent of legato_quickstart_external_resources (external flash reader) application is to demonstrate Legato Graphics Library’s ability to support assets stored on external NVM. Another intent is to highlight possible draw performance drawbacks with these techniques and to serve as a guiding post for UI application designers on their judicious use. Refer to [legato_flash](/gfx_apps_sam_d5x_e5x/apps/legato_flash/) for external NVM programming information. Applications requiring multiple images or non-alphabet-based languages with large number of glyphs, have a very large NVM requirement for their graphics resources. In such applications, storing these graphics resources on-chip may be inefficient or impossible. The solution is to store the graphics resources to off-chip NVM, thereby preserving the on-chip NVM for program memory and allowing for more complex functional features. The legato_quickstart_external_resources (external flash reader) application populates some of its user interface from assets stored on on-chip NVM and other parts of it from assets stored as binary data on an external NVM. The resources are previous copied into the external NVM using the legato_flash application. To demonstrate how to access graphics resources stored on an external memory device, three components are needed: * File Packaging * Bootloader Application * Fetch Application The following figure shows the external resources process diagram. ![](/gfx_apps_sam_d5x_e5x/images/external_resources_flash_reader_diagram.png) |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato_qs_x_r_e54_cult_cpro_parallel.X](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart_ext_res/firmware/legato_qs_x_r_e54_cult_cpro_parallel.X/) | [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) with a 24-bit passthrough GFX interface card and a [maXTouch Curiosity Pro Extension Kit](https://www.microchip.com/Developmenttools/ProductDetails/ATMXT-XPRO) | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_quickstart_ext_res/",
    "relUrl": "/apps/legato_quickstart_ext_res/"
  },"12": {
    "doc": "Legato Showcase",
    "title": "Legato Showcase",
    "content": "# Legato Showcase ![](/gfx_apps_sam_d5x_e5x/images/legato_showcase.png) This demonstration provides a touch-enabled starting point for reading images, string, and multiple fonts from both internal and external non-volatile memory (NVM). |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato_sc_e54_cu_cpro_parallel.X](/gfx_apps_sam_d5x_e5x/apps/legato_showcase/firmware/legato_sc_e54_cu_cpro_parallel.X/) | [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) using external ILI9488 controller to drive the [maXTouch® Curiosity Pro Board](https://www.microchip.com/Developmenttools/ProductDetails/AC320007) | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_showcase/",
    "relUrl": "/apps/legato_showcase/"
  },"13": {
    "doc": "Legato Showcase Plus",
    "title": "Legato Showcase Plus",
    "content": "# Legato Showcase Plus ![](/gfx_apps_sam_d5x_e5x/images/legato_scp_e54_cu.png) This is the showcase graphics demonstration on the SAM E54 Curiosity Ultra Development Board |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato_scp_e54_cu_cpro_parallel.X](/gfx_apps_sam_d5x_e5x/apps/legato_showcase_plus/firmware/legato_scp_e54_cu_cpro_parallel.X/)| [SAM E54 Curiosity Ultra Development Board](https://www.microchip.com/Developmenttools/ProductDetails/DM320210) | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/legato_showcase_plus/",
    "relUrl": "/apps/legato_showcase_plus/"
  },"14": {
    "doc": "LVGL SAM E51 Integrated Graphics and Touch Showcase",
    "title": "LVGL SAM E51 Integrated Graphics and Touch Showcase",
    "content": "# LVGL SAM E51 Integrated Graphics and Touch Showcase ![](/gfx_apps_sam_d5x_e5x/images/lvgl_showcase.png) This application demonstrates a modern music player UI created using LVGL graphics library on the SAME51 Integrated Graphics and Touch Development Board. There are two configurations of this demonstration. |MPLABX Configuration|Board Configuration|Description|:-------------------|:------------------|:------------------| [lvgl_sc_e51_igat.X](/gfx_apps_sam_d5x_e5x/apps/lvgl_showcase/firmware/lvgl_sc_e51_igat.X/)| [SAM E51 Integrated Graphics and Touch Development Board](https://www.microchip.com/developmenttools/ProductDetails/EV14C17A) | Non-RTOS configuration | ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/apps/lvgl_showcase/",
    "relUrl": "/apps/lvgl_showcase/"
  },"15": {
    "doc": "Harmony 3 Graphics SAM D5x/E5x Family Applications Package",
    "title": "Harmony 3 Graphics SAM D5x/E5x Family Applications Package",
    "content": "# ![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_d5x_e5x/images/mhgs.png) MPLAB® Harmony 3 Graphics application examples for SAM D5x/E5x Family MPLAB® Harmony Graphics Suite is an extension of the MPLAB® ecosystem for creating embedded graphics firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB® X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) - [MPLAB® Discover](https://mplab-discover.microchip.com/v1/itemtype/com.microchip.ide.project?s0=Legato) This repository contains the MPLAB® Harmony 3 Graphics application examples for SAM D5x/E5x Family. Graphics applications are standalone applications which demonstrate of some of the capabilities of MPLAB® Harmony Graphics Suite. Refer to the following links for release notes, home page, training materials, framework and application help. For more information on the tools, libraries and basic development with the MPLAB® Harmony Graphics Suite, please see the gfx repo also on github. - [Release Notes](https://microchip-mplab-harmony.github.io/gfx_apps_sam_d5x_e5x/release_notes.html) - [MPLAB® Harmony License](https://microchip-mplab-harmony.github.io/gfx/mplab_harmony_license.html) - [MPLAB® Harmony 3 Graphics User Guides Wiki](https://github.com/mchpgfx/legato.docs/wiki) - [MPLAB® Harmony 3 Graphics API Help](https://mchpgfx.github.io/legato.images/index.html) - [MPLAB® Harmony 3 Graphics Applications](https://microchip-mplab-harmony.github.io/gfx/apps/readme.html) - [MPLAB® Harmony 3 Graphics Videos](https://www.youtube.com/channel/UCwGbrIuty-pHCyjuVRAyP5Q) # Contents Summary | Folder | Description |------------|----------------------------------------------| apps | Example Graphics applications | docs | Contains documentation in html format | Documentation is available for offline viewing. It can be used only after cloning this repository onto a local machine. For online viewing, please use [github pages](https://microchip-mplab-harmony.github.io/gfx_apps_sam_d5x_e5x/) of this repository. ## Graphics application examples (Legato) The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Status | --- | --- | ---- |---- | apps | [legato_benchmark](/gfx_apps_sam_d5x_e5x/apps/legato_benchmark/) | Performance measuring utility example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | | [legato_flash](/gfx_apps_sam_d5x_e5x/apps/legato_flash/) | Flash writer example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | | [legato_quickstart](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart/) | Legato UI library quickstart example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | | [legato_quickstart_ext_res](/gfx_apps_sam_d5x_e5x/apps/legato_quickstart_ext_res/) | Legato UI library external resource example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic)| | [legato_showcase](/gfx_apps_sam_d5x_e5x/apps/legato_showcase/) | Widgets and advance capabilities example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | | [legato_igat_showcase](/gfx_apps_sam_d5x_e5x/apps/legato_igat_showcase/) | Advanced graphics with Integrated touch example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | | [legato_showcase_plus](/gfx_apps_sam_d5x_e5x/apps/legato_showcase_plus/) | Advacned graphics demonstration | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | ## Graphics application examples (Blank) The following applications are provided to demonstrate the ability for the Harmony Graphics Suite to support third-party graphics library. | Category | Item | Description | Release Status | --- | --- | ---- |---- | apps | [blank_quickstart](/gfx_apps_sam_d5x_e5x/apps/blank_quickstart/) | Blank UI-less library quickstart example | ![app-beta](https://img.shields.io/badge/application-release-blue?style=plastic) | ## LVGL Graphics application examples The following applications are provided to demonstrate the ability for the Harmony Graphics Suite to support LVGL graphics library. | Category | Item | Description | Release Status | --- | --- | ---- |---- | apps | [lvgl_showcase](/gfx_apps_sam_d5x_e5x/apps/lvgl_showcase/) | LVGL library Music Player UI example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_d5x_e5x/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Latest release date](https://img.shields.io/github/release-date/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/gfx_apps_sam_d5x_e5x.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_a5d2/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/gfx_apps_sam_d5x_e5x.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() ",
    "url": "http://localhost:4000/gfx_apps_sam_d5x_e5x/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "gfx_apps_sam_d5x_e5x";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Graphics Applications SAM D5x/E5x Family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gfx_apps_sam_d5x_e5x/assets/css/just-the-docs-' + theme + '.css');
}
